...
<head>
    ...
    <!-- Website Title -->
    <title>Privacy Policy - PiTesla</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                            ...
                            <div class="form-container">
                                <form id="privacyForm" data-toggle="validator" data-focus="false">
                                    ...
                                    <div class="form-group checkbox">
                                        <input type="checkbox" id="pterms" value="Agreed-to-Terms" required>I have read and agree to Leno's <a href="privacy-policy">Privacy Policy</a> and <a href="terms-conditions">Terms Conditions</a>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="form-group">
                    ...
                    <a class="btn-outline-reg back" href="index">BACK</a>
                </div> <!-- end of col-->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    ...
    <div class="ex-basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="index">Home</a><i class="fa fa-angle-double-right"></i><span>Privacy Policy</span>
                    </div> <!-- end of breadcrumbs -->
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
