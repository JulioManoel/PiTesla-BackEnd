        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="p-heading p-large">PiTesla possui interfaces individuais para professores e alunos,
                        facilidanto e otimizando sua utilização em cada segmento.</div>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="card left-pane first">
                                        <div class="card-body">
                                            <div class="text-wrapper">
                                                ...
                                                <p>Acompanhe o seu desenvolvimento e desempenho em todas as áreas de
                                                    exatas.</p>
                                            </div>
                                            <div class="card-icon">
                                    ...
                                    <div class="card left-pane">
                                        <div class="card-body">
                                            <div class="text-wrapper">
                                                <h4 class="card-title">On-Demand</h4>
                                                <p>Acesse os conteúdos quando e onde quiser.</p>
                                            </div>
                                            <div class="card-icon">
                                    ...
                                    <div class="card left-pane">
                                        <div class="card-body">
                                            <div class="text-wrapper">
                                                ...
                                                <p>Ganhe enquanto estuda, através do sistema de recompensa de
                                                    criptomoedas.</p>
                                            </div>
                                            <div class="card-icon">
                                    ...
                                    <div class="icon-cards-area">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p>Crie conteúdos personalizados que atendam às necessidades de cada
                                                    turma.</p>
                                            </div>
                                        </div>
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h4 class="card-title">Fácil leitura</h4>
                                                <p>Garanta que seus alunos terão acesso a uma interface simples e
                                                    eficiente.</p>
                                            </div>
                                        </div>
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h4 class="card-title">Estudo paralelo</h4>
                                                <p>Crie conteúdos que auxiliem os alunos em períodos de avaliação.</p>
                                            </div>
                                        </div>
                                        <div class="card">
                                            <div class="card-icon">
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="list-unstyled li-space-lg">
                        <li class="address">Nos mande uma mensagem e tire suas dúvidas</li>
                        <li><i class="fas fa-map-marker-alt"></i>Rodovia Senador José Ermírio de Moraes, 1425 - Jardim
