...
<head>
    ...
    <!-- Website Title -->
    <title>PiTesla - Mobile App</title>
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="/"><img src="{{ asset('images/miniLogo.png') }}" alt="alternative"></a> 
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle page-scroll" href="#details" id="navbarDropdown" role="button" aria-haspopup="true" aria-expanded="false">DETALHES</a>
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="terms-conditions"><span class="item-text">TERMOS E CONDIÇÕES</span></a>
                        <div class="dropdown-items-divide-hr"></div>
                        <a class="dropdown-item" href="privacy-policy"><span class="item-text">POLÍTICA DE PRIVACIDADE</span></a>
                    </div>
                </li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="image-container">
                            <img class="img-fluid" src="{{ asset('images/header-iphone.png') }}" alt="alternative">
                    ...
                    <div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1">
                        <div class="container">
                            <div class="row">
                                ...
                                <!-- Image Pane -->
                                <div class="col-lg-4">
                                    <img class="img-fluid" src="{{ asset('images/features-iphone-1.png') }}" alt="alternative">
                                </div>
                                <!-- end of image pane -->
                    ...
                    <div class="tab-pane fade" id="tab-2" role="tabpanel" aria-labelledby="tab-2">
                        <div class="container">
                            <div class="row">
                                ...
                                <!-- Image Pane -->
                                <div class="col-md-4">
                                    <img class="img-fluid" src="{{ asset('images/features-iphone-2.png') }}" alt="alternative">
                                </div>
                                <!-- end of image pane -->
                    ...
                    <div class="tab-pane fade" id="tab-3" role="tabpanel" aria-labelledby="tab-3">
                        <div class="container">
                            <div class="row">
                                ...
                                <!-- Image Pane -->
                                <div class="col-md-4">
                                    <img class="img-fluid" src="{{ asset('images/features-iphone-3.png') }}" alt="alternative">
                                </div>
                                <!-- end of image pane -->
    ...
    <div id="details" class="basic-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <img class="img-fluid" src="{{ asset('images/details-1-iphone.png') }}" alt="alternative">
                </div> <!-- end of col -->
                <div class="col-lg-6">
                    <div class="text-container">
                        <h3>Goals Setting</h3>
        ...
        <div class="second">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img class="img-fluid" src="{{ asset('images/details-2-iphone.png') }}" alt="alternative">
                    </div> <!-- end of col -->
                </div> <!-- end of row -->
            </div> <!-- end of container -->
        </div> <!-- end of second -->
	...
	<div id="details-lightbox-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
		<div class="row">
			...
			<div class="col-lg-6">
				<img class="img-fluid" src="{{ asset('images/details-lightbox-1.png') }}" alt="alternative">
			</div>
			<div class="col-lg-6">
				<h3>Goals Setting</h3>
				<hr>
    ...
    <div id="details-lightbox-2" class="lightbox-basic zoom-anim-dialog mfp-hide">
		<div class="row">
			<button title="Close (Esc)" type="button" class="mfp-close x-button">×</button>
			<div class="col-lg-6">
				<img class="img-fluid" src="{{ asset('images/details-lightbox-2.png') }}" alt="alternative">
			</div>
			<div class="col-lg-6">
				<h3>Calendar Input</h3>
				<hr>
                    ...
                    <div class="slider-container">
                        <div class="swiper-container image-slider">
                            <div class="swiper-wrapper">
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <a href="{{ asset('images/screenshot-1.png') }}" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{ asset('images/screenshot-1.png') }}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <a href="{{ asset('images/screenshot-2.png') }}" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{ asset('images/screenshot-2.png') }}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <a href="{{ asset('images/screenshot-3.png') }}" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{ asset('images/screenshot-3.png') }}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <a href="{{ asset('images/screenshot-4.png') }}" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{ asset('images/screenshot-4.png') }}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <a href="{{ asset('images/screenshot-5.png') }}" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{ asset('images/screenshot-5.png') }}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <a href="{{ asset('images/screenshot-6.png') }}" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{ asset('images/screenshot-6.png') }}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <a href="{{ asset('images/screenshot-7.png') }}" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{ asset('images/screenshot-7.png') }}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <a href="{{ asset('images/screenshot-8.png') }}" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{ asset('images/screenshot-8.png') }}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <a href="{{ asset('images/screenshot-9.png') }}" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{ asset('images/screenshot-9.png') }}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
                                ...
                                <!-- Slide -->
                                <div class="swiper-slide">
                                    <a href="{{ asset('images/screenshot-10.png') }}" class="popup-link" data-effect="fadeIn">
                                        <img class="img-fluid" src="{{ asset('images/screenshot-10.png') }}" alt="alternative">
                                    </a>
                                </div>
                                <!-- end of slide -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-xl-7">
                    <div class="image-container">
                        <img class="img-fluid" src="{{ asset('images/download.png') }}" alt="alternative">
                ...
                <div class="col-lg-6 offset-lg-3">
                    ...
                    <form id="contactForm" data-toggle="validator" data-focus="false">
                        ...
                        <div class="form-group checkbox">
                            <input type="checkbox" id="cterms" value="Agreed-to-Terms" required>I have read and agree to Leno's stated conditions in <a href="privacy-policy">Privacy Policy</a> and <a href="terms-conditions">Terms Conditions</a> 
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="footer-col middle">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            ...
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Read our <a class="turquoise" href="terms-conditions">Terms & Conditions</a>, <a class="turquoise" href="privacy-policy">Privacy Policy</a></div>
                            </li>
                        </ul>
                    </div>
                </div> <!-- end of col -->
